...
typedef enum
{
    /*! MainState during initialization phase */
    MainState_Initial,

    /*! MainState if currently user code processed */
    MainState_Run,

    /*! MainState if idle with active wait for elapsed */
    MainState_Wait,

    /*! MainState with exceeded main cycle time */
    MainState_Error,
} MainState_State;
